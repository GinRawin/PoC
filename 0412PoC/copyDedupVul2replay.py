...
DEFAULT_DEDUP_ROOT = Path("/mnt/sdb/hjr/HouseFuzz/deal/dedupVul")
DEFAULT_REPLAY_FIRMWARE_ROOT = Path("/mnt/sdb/hjr/HouseFuzz/data/0412firmwarefuzz/replayfirmware")
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "*.request.raw files into replay/0412PoC."
        ),
    )
    parser.add_argument(
