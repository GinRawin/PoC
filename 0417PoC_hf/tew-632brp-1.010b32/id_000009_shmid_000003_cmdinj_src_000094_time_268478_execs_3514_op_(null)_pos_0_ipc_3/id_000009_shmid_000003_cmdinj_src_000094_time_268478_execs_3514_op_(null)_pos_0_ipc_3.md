...
Trendnet TEW-632BRP httpd 0x40c39c 命令注入漏洞
...
第二步。0x40c3f4/0x40c410 读取 wps_sta_enrollee_pin，0x40c420-0x40c47c 用 sprintf 格式化为 wsc_cfg pin <pin>

第三步。0x40c494 将该缓冲区交给 system，
![alt text](image.png)
相关问题代码：
